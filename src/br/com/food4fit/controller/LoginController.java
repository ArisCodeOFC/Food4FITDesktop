...
public class LoginController {
	...
	public void txtMatriculaKey() {
		TextFieldFormatter tff = new TextFieldFormatter(txtMatricula, "(##)####-####", "[^0-9]");
	}


	public void txtSenhaKey() {
		TextFieldFormatter tff = new TextFieldFormatter(txtSenha, "{10}", "*");
	}
